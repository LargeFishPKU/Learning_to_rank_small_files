...
class PRank_Dataset:
    def __init__(self, id2voc_file, small_cooccur_path, batch_size, bias_number):
        self.ids = []
    ...
    def __getitem__(self, i):
        ...
        all_labels = self.generate_labels(all_targets_number, self.bias_number)
    ...
    def generate_labels(self, target_number, bias_number):
        labels = []
        k = dict()
